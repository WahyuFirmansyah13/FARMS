...
<div class="card">
    <div class="card-body">
        ...
        <?php endif; ?>
        <form action="<?= base_url(session('role') . '/profil/update') ?>" method="post" enctype="multipart/form-data">
            <?= csrf_field() ?>
            <div class="mb-3">
            ...
            <a href="<?= base_url(session('role') . '/profil') ?>" class="btn btn-secondary">Batal</a>
        </form>
    </div>
</div>
